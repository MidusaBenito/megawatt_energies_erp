...
class Product(models.Model):
    ...
    measurement_choices = [
        ("piece", "Piece"), ("box", "Box"), ("pallet", "Pallet"), ("metre", "Metre"), ("kg", "Kg"), ("litre", "Litre"), ("other", "Other"), ("not_selected", "Not Selected")]
    ...
    def save(self, *args, **kwargs):
        if not self.pk:
            ...
            self.stock_keeping_unit = f'{self.pk}'+ numberReg
...
class StockTransaction(models.Model):
    ...
    stock_transaction_reference = models.CharField(
        max_length=50, default="",) #will store the stock order number or sales order number that the stock transaction is fullfilling
...
class StockTransactionInstance(models.Model):
    ...
    stock_transaction = models.ForeignKey(
        StockTransaction, null=True, on_delete=models.SET_NULL, related_name="stock_transaction_instannces")
...
class Equipment(models.Model):
    ...
    equipment_name = models.CharField(max_length=100, default="", unique=True)
    equipment_description = models.CharField(max_length=500, default="",)
    status_choices = [
        ("operational", "Operational"), ("under_maintenance", "Under Maintenance"), ("decommision", "Decommision"), ("not_selected", "Not Selected")]
